 ...
 */
this.PIXI = this.PIXI || {};
this.PIXI.spine41 = this.PIXI.spine41 || {};
    ...
    ***************************************************************************** */
            ...
            for (var i_1 = 0, n_1 = tracks.length; i_1 < n_1; i_1++) {
                ...
                if ((i_1 == 0 && mix == 1) || blend == base.MixBlend.add) {
                    ...
                    for (var ii = 0; ii < timelineCount; ii++) {
                        ...
                        var timelineBlend = timelineMode[ii] == SUBSEQUENT ? blend : base.MixBlend.setup;
                        if (!shortestRotation && timeline_1 instanceof RotateTimeline) {
                            ...
                            base.Utils.webkit602BugfixHelper(mix, blend);
                            timeline_1.apply(skeleton, animationLast, applyTime, applyEvents, mix, timelineBlend, base.MixDirection.mixIn);
                        }
                    }
                }
    ...
    var IkConstraint = /** @class */ (function () {
        ...
        IkConstraint.prototype.apply1 = function (bone, targetX, targetY, compress, stretch, uniform, alpha) {
            ...
            var skelY = base.settings.yDown ? -bone.skeleton.scaleY : bone.skeleton.scaleY;
            switch (bone.data.transformMode) {
                case base.TransformMode.OnlyTranslation:
                    tx = targetX - bone.worldX;
                    ty = targetY - bone.worldY;
                    //TODO: possible bug in spine-ts runtime!
                    if (base.settings.yDown) {
                        ty = -ty;
                    }
                    break;
                case base.TransformMode.NoRotationOrReflection:
    ...
    var PathConstraintData = /** @class */ (function (_super) {
        ...
        function PathConstraintData(name) {
            ...
            _this.positionMode = base.PositionMode.Fixed;
            /** The mode for positioning the bones after the first bone on the path. */
            _this.spacingMode = exports.SpacingMode.Fixed;
            /** The mode for adjusting the rotation of the bones. */
            _this.rotateMode = base.RotateMode.Chain;
    ...
    var PathConstraint = /** @class */ (function () {
        ...
        PathConstraint.prototype.update = function () {
            ...
            if (mixRotate == 0 && mixX == 0 && mixY == 0)
                return;
            var data = this.data;
            var tangents = data.rotateMode == base.RotateMode.Tangent, scale = data.rotateMode == base.RotateMode.ChainScale;
            var bones = this.bones;
            var boneCount = bones.length, spacesCount = tangents ? boneCount : boneCount + 1;
            var spaces = base.Utils.setArraySize(this.spaces, spacesCount), lengths = scale ? this.lengths = base.Utils.setArraySize(this.lengths, boneCount) : [];
        ...
        PathConstraint.prototype.computeWorldPositions = function (path, spacesCount, tangents) {
            ...
            var spaces = this.spaces, out = base.Utils.setArraySize(this.positions, spacesCount * 3 + 2), world = this.world;
    ...
    var Skeleton = /** @class */ (function () {
        ...
        Skeleton.prototype.getBoundsRect = function () {
            var offset = new base.Vector2();
            var size = new base.Vector2();
            ...
            for (var i = 0, n = input.readInt(true); i < n; i++) {
                ...
                for (var ii = 0, nn = input.readInt(true); ii < nn; ii++) {
                    switch (input.readByte()) {
                        case PATH_POSITION:
                            timelines
                                .push(readTimeline1$1(input, new PathConstraintPositionTimeline(input.readInt(true), input.readInt(true), index), data.positionMode == base.PositionMode.Fixed ? scale : 1));
                            break;
                        case PATH_SPACING:
                            timelines
...
if (typeof _pixi_spine_runtime_ !== 'undefined') { Object.assign(this.PIXI.spine41, _pixi_spine_runtime_); }

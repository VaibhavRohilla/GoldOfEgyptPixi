 ...
 */
this.PIXI = this.PIXI || {};
this.PIXI.spine38 = this.PIXI.spine38 || {};
    ...
    ***************************************************************************** */
    ...
    var DeformTimeline = /** @class */ (function (_super) {
        ...
        DeformTimeline.prototype.apply = function (skeleton, lastTime, time, firedEvents, alpha, blend, direction) {
            ...
            if (time < frames[0]) {
                ...
                switch (blend) {
                    ...
                    case base.MixBlend.first:
                        ...
                        var deform_1 = base.Utils.setArraySize(deformArray, vertexCount);
            ...
            var deform = base.Utils.setArraySize(deformArray, vertexCount);
            if (time >= frames[frames.length - 1]) { // Time is after last frame.
        ...
        AnimationState.prototype.apply = function (skeleton) {
            ...
            for (var i_1 = 0, n_1 = tracks.length; i_1 < n_1; i_1++) {
                ...
                if (current == null || current.delay > 0)
                    continue;
                applied = true;
                var blend = i_1 == 0 ? base.MixBlend.first : current.mixBlend;
                ...
                if ((i_1 == 0 && mix == 1) || blend == base.MixBlend.add) {
                    ...
                    for (var ii = 0; ii < timelineCount; ii++) {
                        ...
                        var timelineBlend = timelineMode[ii] == AnimationState.SUBSEQUENT ? blend : base.MixBlend.setup;
                        if (timeline_1 instanceof RotateTimeline) {
                            ...
                            base.Utils.webkit602BugfixHelper(mix, blend);
                            timeline_1.apply(skeleton, animationLast, animationTime, events, mix, timelineBlend, base.MixDirection.mixIn);
                        }
                    }
                }
        ...
        AnimationState.prototype.applyMixingFrom = function (to, skeleton, blend) {
            ...
            if (blend == base.MixBlend.add) {
                ...
                for (var i = 0; i < timelineCount; i++) {
                    ...
                    var direction = base.MixDirection.mixOut;
                    ...
                    if (timeline instanceof RotateTimeline)
                        ...
                        if (drawOrder && timeline instanceof DrawOrderTimeline && timelineBlend == base.MixBlend.setup)
        ...
        Bone.prototype.updateWorldTransformWith = function (x, y, rotation, scaleX, scaleY, shearX, shearY) {
            ...
            switch (this.data.transformMode) {
                ...
                case base.TransformMode.NoScaleOrReflection: {
                    ...
                    if (this.data.transformMode == base.TransformMode.NoScale
    ...
    var PathConstraint = /** @class */ (function () {
        ...
        PathConstraint.prototype.update = function () {
            ...
            var tangents = rotateMode == base.RotateMode.Tangent, scale = rotateMode == base.RotateMode.ChainScale;
            ...
            var positions = this.computeWorldPositions(attachment, spacesCount, tangents, data.positionMode == base.PositionMode.Percent, spacingMode == exports.SpacingMode.Percent);
    ...
    var SkeletonBinary = /** @class */ (function () {
        ...
        SkeletonBinary.prototype.readAnimation = function (input, name, skeletonData) {
            ...
            var scale = this.scale;
            var duration = 0;
            var tempColor1 = new base.Color();
            var tempColor2 = new base.Color();
            // Slot timelines.
            for (var i = 0, n = input.readInt(true); i < n; i++) {
                var slotIndex = input.readInt(true);
                for (var ii = 0, nn = input.readInt(true); ii < nn; ii++) {
        ...
        SkeletonBinary.TransformModeValues = [base.TransformMode.Normal, base.TransformMode.OnlyTranslation, base.TransformMode.NoRotationOrReflection, base.TransformMode.NoScale, base.TransformMode.NoScaleOrReflection];
        ...
        SkeletonJson.prototype.readAnimation = function (map, name, skeletonData) {
            ...
            if (map.events) {
                ...
                for (var i = 0; i < map.events.length; i++) {
                    ...
                    var event_1 = new Event(base.Utils.toSinglePrecision(this.getValue(eventMap, "time", 0)), eventData);
...
if (typeof _pixi_spine_runtime_ !== 'undefined') { Object.assign(this.PIXI.spine38, _pixi_spine_runtime_); }
